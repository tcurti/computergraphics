...
function recomputeImages() 
{
    ...
    var algorithm = document.getElementById('inputalgorithm').value;
...
window.onload = function() 
{
    ...
    // asocio inputalgorithm a la función recomputeImages()
    var inputalgorithm   = document.getElementById('inputalgorithm');
    inputalgorithm.addEventListener('change', recomputeImages);
